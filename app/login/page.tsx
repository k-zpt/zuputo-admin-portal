...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (errorParam === 'unauthorized') {
      setError("Access denied. Your account is not authorized to access this portal. Please contact an administrator.");
      // Sign out the user if they're logged in but not authorized
    ...
    try {
      ...
      if (result?.error) {
        if (result.error === "AccessDenied") {
          setError("Access denied. Please use an email from the allowed domain.");
        } else {
